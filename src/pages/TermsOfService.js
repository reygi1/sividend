...
const TermsofService = () => {
  return (
    <div>
      <h1 style={{ textAlign: "center", paddingBottom: "2em" }}>
        Terms of Service
      </h1>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Sividend.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Sividend, accessible from{" "}
            <a
              href="sividend.com"
      ...
      <ul>
        <li>
          ...
          <a
            href="sividend.com/contanct"
            rel="external nofollow noopener"
            target="_blank"
          >
            sividend.com/contanct
          </a>
        </li>
      </ul>
    </div>

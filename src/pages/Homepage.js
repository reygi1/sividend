  ...
  return (
    <div>
      <div className="container">
        ...
        <p className="subhead">
          Get the latest Sentiment Analysis of Stocks from Financial News,
        ...
        <div className="container">
          <ul className="ul-blue">
            <li>
              ...
              <p>
                Get accurate financial data for more than 6,000 tickers.
                Everything you need is in our dashboard. Sentiment Analysis,
                Financials, Market Data and Charts.
              </p>
            </li>
            <li>
              <img src={idea} alt="icon 2" />
              <p>
                Validate your trading ideas from our indicators. Get updated
                data every 24 hours on each ticker from our proprietary
                Sentiment Algorithm.
              </p>
            </li>
            <li>
              ...
              <p>
                You have everything in our platform. No need to download
                anything. The software is hosted on our website, check the demo
                to try it now.
              </p>
            </li>
          </ul>
      ...
      <div className="container">
        <div className="imgcont">
          <h2>
            We have over 6,000 stocks from the two biggest exchanges in the
            world
          </h2>
          <ul>
            <li>

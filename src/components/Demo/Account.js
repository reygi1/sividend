    ...
    <div class="row my-2">
        <div class="col-lg-8 order-lg-2">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <div data-target="#profile" data-toggle="tab" class="nav-link active">Profile</div>
                </li>
                <li class="nav-item">
                    <div data-target="#messages" data-toggle="tab" class="nav-link">Messages</div>
                </li>
                <li class="nav-item">
                    <div  data-target="#edit" data-toggle="tab" class="nav-link">Edit</div>
                </li>
            </ul>
                ...
                <div class="tab-pane active" id="profile">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <hr />
                            <span class="badge badge-primary"><i class="fa fa-user"></i> New Investor Badge</span>
                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table table-sm table-hover table-striped">
                                <tbody>                                    
                                    ...
                                    <tr>
                                        <td>
                                            Logged in from London, United Kingdom
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>

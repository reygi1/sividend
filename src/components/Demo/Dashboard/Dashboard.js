...
const Dashboard = () => {
  const handlePosNeg = (n) => {
    ...
    else if (n.includes("-")) return "negative";
  ...
  if (
    ...
    !stockData.quoteSummary.result[0].financialData
  ) {
    return (
    ...
    return (
      <div className="dashBody">
        ...
        <div className="title">
          <h1>{stockData.quoteSummary.result[0].price.shortName}</h1>
        </div>
          ...
          <div className="sentiment-container">
            ...
            >
              ...
              >
                ...
                <Icon
                  styles={{
                    root: { color: "#0078d4", verticalAlign: "middle" },
                  }}
                ...
                <div className="sentiment-inside">
                  {sentimentData === null ? (
                    ...
                    <div className="sentcont1">
                      ...
                      >
                        Sentiment score ranges between 0 and 100, 0 being very
                        negative sentiment, 50 being neutral sentiment and 100
                        being very positive sentiment. Data is updated in
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <span>
                                <ReactStoreIndicator
                                  value={
                                    sentimentData.gnews > 1
                                      ? 100
                                      : sentimentData.gnews < -1
                                      ? 0
                                      : ((sentimentData.gnews + 1) / 2) * 100
                                  }
                                  maxValue={100}
                                  stepsColors={[
                                    "#d12000",
                          ...
                          <tr>
                            ...
                            <td>
                              <span>
                                <ReactStoreIndicator
                                  value={
                                    sentimentData.twitter > 1
                                      ? 100
                                      : sentimentData.twitter < -1
                                      ? 0
                                      : ((sentimentData.twitter + 1) / 2) * 100
                                  }
                                  maxValue={100}
                                  stepsColors={[
                                    "#d12000",
                          ...
                          <tr>
                            ...
                            <td>
                              <span>
                                <ReactStoreIndicator
                                  value={
                                    sentimentData.stwits > 1
                                      ? 100
                                      : sentimentData.stwits < -1
                                      ? 0
                                      : ((sentimentData.stwits + 1) / 2) * 100
                                  }
                                  maxValue={100}
                                  stepsColors={[
                                    "#d12000",
              ...
              <Card.Item>
                <table className="table" id="tableprice">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <span>Daily volume(3Month):</span>
                        <span>
                          <strong>
                            {
                              stockData.quoteSummary.result[0].price
                                .averageDailyVolume3Month.fmt
                            }
                          </strong>
                        </span>
                      </td>
                      ...
                      <td>
                        ...
                        <span>
                          <strong>
                            {
                              stockData.quoteSummary.result[0].price.marketCap
                                .fmt
                            }
                          </strong>
                        </span>
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      ...
                      <span
                        className={handlePosNeg(
                          stockData.quoteSummary.result[0].financialData.ebitda
                            .fmt
                        )}
                      >
                        <strong>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        ...
                        <span>
                          {
                            stockData.quoteSummary.result[0].summaryProfile
                              .longBusinessSummary
                          }
                        </span>
                      </td>
                    ...
                    <tr>
                      <td>
                        ...
                        <span>
                          ...
                          ,{" "}
                          {stockData.quoteSummary.result[0].summaryProfile.city}{" "}
                          {
                            stockData.quoteSummary.result[0].summaryProfile
                              .state
                          }{" "}
                          {stockData.quoteSummary.result[0].summaryProfile.zip},{" "}
                          {
                            stockData.quoteSummary.result[0].summaryProfile
                              .country
                          }

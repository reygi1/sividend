...
class ChartD extends React.Component {
	...
	render() {
		...
		const height =  404;
		const width = width1;
		const { type, data: initialData, mouseMoveEvent, ratio, panEvent, zoomEvent,clamp } = this.props;
			...
			>
				...
				>
					<YAxis axisAt="right" orient="right" ticks={5} {...yGrid} inverted={true}
						tickStroke="#FFFFFF" zoomEnabled={zoomEvent} />
					<XAxis axisAt="bottom" orient="bottom" showTicks={true} outerTickSize={0}
						 opacity={0.5} zoomEnabled={zoomEvent}/>
